...
int main(){
    ...
    p[0] = (const mhs){"Fareed",12015,"Surabaya",4.00}; //data pertama
    p[1] = (const mhs){"Jahiz",12036,"Palembang",2.00}; //data konstan
    do{
        ...
        if(pilihan == 1){
            ...
            //setelah memilih menu, akan keluar pilihan untuk kembali ke menu atau tidak(program berakhir)
